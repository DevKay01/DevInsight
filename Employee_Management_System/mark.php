...
<html>
<head>
  <title>Site Mark | SecurityGuard Management System</title>
  <!-- Icons font CSS-->
  ...
  <header>
    <nav>
      ...
      <ul id="navli">
        ...
        <li><a class="homeblack" href="assign.php">Assign Site</a></li>
        <li><a class="homered" href="assignproject.php">Site Status</a></li>
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="mark.php" method="POST">
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="update">Assign Site</button>
                        </div>
