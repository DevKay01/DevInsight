...
<head>
    ...
    <!-- Title Page-->
    <title>Assign Project | Admin Panel | SecurityGuard Management System</title>
    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homered" href="assign.php">Assign Site</a></li>
                <li><a class="homeblack" href="assignproject.php">Site Status</a></li>
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/assignp.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Site Name" name="pname" required="required">
                        </div>
