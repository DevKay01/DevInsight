...
<html>
<head>
  <title>My Profile | SecurityGuard Management System</title>
  <!-- Icons font CSS-->
...
<body>
  <header>
    <nav>
      <h1>SecurityGuard Management System</h1>
      <ul id="navli">
        <li><a class="homeblack" href="eloginwel.php?id=<?php echo $id?>"">HOME</a></li>
        <li><a class="homered" href="myprofile.php?id=<?php echo $id?>"">My Profile</a></li>
        <li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"">My Site</a></li>
